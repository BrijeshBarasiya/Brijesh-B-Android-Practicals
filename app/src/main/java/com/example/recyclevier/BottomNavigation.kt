...
class BottomNavigation : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Using Frame layout
        /*replceLayout(FirstFragment())
        buttom_navigation.setOnItemSelectedListener {
            when(it.itemId) {
                R.id.nav_home -> replceLayout(FirstFragment())
                R.id.nav_call -> replceLayout(SecondFragment())
                R.id.nav_profile -> replceLayout(FirstFragment())
                R.id.nav_setting -> replceLayout(SecondFragment())
            }
            true
        }*/
    ...
    //Using Frame layout
    /*private fun replceLayout(fragment: Fragment) {
        val fragmentLayout = supportFragmentManager.beginTransaction()
        fragmentLayout.add(R.id.frame_layout, fragment)
        //val transaction = fragmentLayout.add(R.id.frame_layout, fragment)
        //fragmentLayout.addToBackStack(null)
        fragmentLayout.commit()
    }*/
